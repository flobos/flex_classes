/*
 * frm_adm_solicitudes.java
 *
 * Created on 22 de noviembre de 2005, 02:58 PM
 */
...
public class frm_adm_solicitudes {
 //***********************************************************************************************************
 ...
 // frm_adm_solicitudes.mxml --by.SyOuS
 //***********************************************************************************************************      
      public static ArrayList<obj_un_campo_string> ro_solicitud_carga_nombre_funcionario(String fun_rut) {
        ...
        try {
            ...
            c = conexion_odbc.Connexion_datos();
            CallableStatement cs;
            sql = "flex_adm_solicitudes_carga_nombre_funcionario '" + fun_rut +"'";
            cs = c.prepareCall(sql);
            ResultSet rs = cs.executeQuery();
 ...
 // frm_adm_solicitudes.mxml --by.SyOuS
 //***********************************************************************************************************      
      public static ArrayList<obj_dos_campos> ro_solicitud_carga_documentos_a_tramitar(String sol_idn, String tram_idn) {
        ...
        try {
            ...
            c = conexion_odbc.Connexion_datos();
            CallableStatement cs;
            sql = "flex_adm_solicitudes_carga_documentos_a_tramitar '" + sol_idn +"', '" + tram_idn + "'";
            cs = c.prepareCall(sql);
            ResultSet rs = cs.executeQuery();
 ...
 //***********************************************************************************************************      
      public static ArrayList<obj_un_campo_string> ro_solicitud_inserta_tramitacion(String func_mod_fun_idn
        ...
        try {
            ...
            c = conexion_odbc.Connexion_datos();
            CallableStatement cs;
            sql = "flex_adm_solicitudes_inserta_tramitacion '" + func_mod_fun_idn +"', '" + sol_idn +"'";
            cs = c.prepareCall(sql);
            ResultSet rs = cs.executeQuery();
            while (rs.next())
            {
