/*
 * frm_adm_mat_crea_bibliotecas_base.java
 *
 ...
 * @author  Esteban
 */
public class frm_adm_mat_crea_bibliotecas_base {
//***********************************************************************************************************                 
    ...
    ArrayList<obj_tres_campos> lista = new ArrayList<obj_tres_campos>();
        ...
        try {
            ...
            while (rs.next()){
             ...
             lista.add(new obj_tres_campos(rs.getString("bib_vir_bas_idn"),
                                            rs.getString("bib_vir_bas_nombre"),
                                            rs.getString("bib_vir_bas_fecha_ingreso")));
...
public static ArrayList<obj_un_campo_string> inserta_biblioteca_virtual(String bib_vir_nombre) {
    ArrayList<obj_un_campo_string> lista = new ArrayList<obj_un_campo_string>();
        ...
        try {
            String sql;
            c = conexion_odbc.Connexion_datos();
            sql = "{call flex_biblioteca_virtual_base_inserta (?)}" ;//
            CallableStatement ps = c.prepareCall(sql);
...
public static ArrayList<?> elimina_biblioteca_virtual(String bib_vir_idn) {
    ArrayList<?> lista = new ArrayList<Object>();
        ...
        try {
            String sql;
            c = conexion_odbc.Connexion_datos();
            sql = "{call flex_biblioteca_virtual_base_elimina (?)}" ;//
            CallableStatement ps = c.prepareCall(sql);
    ...
    public frm_adm_mat_crea_bibliotecas_base() {
    }
