 ...
 * @author  Esteban
 */
public class frm_adm_mensajeria_nuevo_msg2 {
//*********************************************************************************************************** 
...
//*********************************************************************************************************** 
 public static ArrayList<obj_un_campo_string> buscar_numero_envio_mensaje() {
        ...
        try {
            ...
            sql = "frm_adm_mensajeria_nuevo_msg_busca_numero_envio";
...
public static ArrayList<obj_dos_campos> guarda_info_datos_adjuntos(int mens_idn,String dat_adj_nombre) 
     {
        ...
        try {
                        ...
                        c = conexion_odbc.Connexion_datos();
                        sql = "{call frm_adm_mesajeria_nuevo_msg_inserta_datos_adjuntos (?,?)}" ;
                        CallableStatement ps = c.prepareCall(sql);
                        ps.setInt(1,mens_idn);
                        ps.setString(2,dat_adj_nombre.trim());
                        ps.execute();
...
//***********************************************************************   
    ...
    public frm_adm_mensajeria_nuevo_msg2() {
    }
