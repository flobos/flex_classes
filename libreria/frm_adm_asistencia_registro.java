 ...
 */
public class frm_adm_asistencia_registro {
    
    /** Creates a new instance of frm_adm_asistencia_registro */
    public frm_adm_asistencia_registro() {
    }
 ...
 public static ArrayList<obj_dos_campos> muestra_dias_clases(int funcion_modalidad) {
   ...
   public static ArrayList<obj_dos_campos> muestra_secciones_con_clases(int funcion_modalidad, String fecha_clase) {
    ArrayList<obj_dos_campos> lista = new ArrayList<obj_dos_campos>();
        Connection c=null;
    ...
    public static ArrayList<obj_cinco_campos> muestra_alumnos_seccion(int clase) {
