 ...
 * @author  Esteban
 */
public class frm_adm_sube_pruebas_tutorV2 {
...
//************************************************************************************
    ...
    public static ArrayList<obj_dos_campos> ro_elimina_datos_dg_pruebas(String eva_eje_idn) {
    ArrayList<obj_dos_campos> lista = new ArrayList<obj_dos_campos>();
        Connection c=null;
        String msg;
        ...
        try {
            String sql;
            c = conexion_odbc.Connexion_datos();
            sql = "{call frm_adm_sube_pruebas_tutor_elimina_datos (?)}" ;
            CallableStatement ps = c.prepareCall(sql);
            ps.setString(1,eva_eje_idn.trim());
...
//---------------------------------------------------
             ...
             public String elimina_envio(String nombre) throws Exception 
    {
         
    
          //------------------Busca el archivo------------------
        
         File bkup = new File("C:/jrun4/servers/default/cfusion/ipxcf/uploadprueba/"+nombre);//+"/"+nombre_antiguo+".jpg"); 
        ...
        {  
        /*      El archivo existe       */  
         borrarDirectorio("C:/jrun4/servers/default/cfusion/ipxcf/uploadprueba/"+nombre);
       // bkup.delete(); //lo borra
