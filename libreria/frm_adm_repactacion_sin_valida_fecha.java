/*
 * frm_adm_repactacion_sin_valida_fecha.java
 *
 * Created on 27 de junio de 2008, 10:10
 */
 ...
 * @author  villanueva
 */
public class frm_adm_repactacion_sin_valida_fecha {
    
    /** Creates a new instance of frm_adm_repactacion_sin_valida_fecha */
    public frm_adm_repactacion_sin_valida_fecha() {
    }
    //**********************************************
...
public static ArrayList<obj_siete_campos> carga_pagos_atrasados_alumno(String mat_idn) {
    ArrayList<obj_siete_campos> lista = new ArrayList<obj_siete_campos>();
        ...
        try {
            String sql;
            c = conexion_odbc.Connexion_datos();
            sql = "{call flex_adm_repactacion_carga_pagos_atrasados_alumnos_todos_los_años (?)}" ;
            CallableStatement ps = c.prepareCall(sql);
