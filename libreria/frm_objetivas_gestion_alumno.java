 ...
 * @author Joliveros
 */
public class frm_objetivas_gestion_alumno {
...
//******************************************************************************************************************************************************    
     ...
     //******************************************************************************************************************************************************    
     public static ArrayList<obj_tres_campos> muestra_preguntas_respuestas (String trab_idn) {
         ArrayList<obj_tres_campos> lista = new ArrayList<obj_tres_campos>();
        Connection c=null;
         try {
            String sql;
            c = conexion_odbc.Connexion_datos();
            sql = "{call frm_pruebas_objetiva_gestion_muestra_preguntas_respuestas(?)}" ;
            CallableStatement ps = c.prepareCall(sql);
            ps.setString(1, trab_idn.trim());
            ResultSet rs = ps.executeQuery();
             ...
             while (rs.next()){
                ...
                lista.add(new obj_tres_campos( rs.getString("eje_aca_preg_pregunta"),
     ...
     public static ArrayList<obj_un_campo_string> recalcular_nota(String trab_idn ) {
...
//******************************************************************************************************************************************************        
    public frm_objetivas_gestion_alumno() {
    }
