/*
 * frm_tutor_foro_ejec_academica.java
 *
 * Created on 13 de diciembre de 2005, 7:39
 */
...
public class frm_tutor_foro_ejec_academica {
...
////***************************************************************************************************      
    ...
    ////***************************************************************************************************      
      ...
      public static ArrayList<obj_un_campo> foro_respuesta_tutor(int for_res_idn, String for_res_contenido) {
    ArrayList<obj_un_campo> lista = new ArrayList<obj_un_campo>();
    Connection c=null;
    int salida = 1;
    try {
 ...
 ////***************************************************************************************************      
      ...
      public static ArrayList<obj_un_campo> foro_bloquea_texto(int for_res_idn) {
    ArrayList<obj_un_campo> lista = new ArrayList<obj_un_campo>();
    Connection c=null;
    int salida = 1;
    try {
...
////***************************************************************************************************      
    ...
    /** Creates a new instance of frm_tutor_foro_ejec_academica */
    public frm_tutor_foro_ejec_academica() {
    }
